...
6. Add typed implementation constraints, validation signals, reversal cost, and revisit triggers.
...
Missing evidence or an unresolved user-owned trade-off is an explicit blocker. Use `apex/recordInput` only for a
...
accepted evidence references. Include lifecycle state, implementation constraints, revisit triggers, and blockers.
