...
6. For Azure Functions intent, assess trigger, identity, network, data, and observability requirements. Record
   unavailable materialization as a future backlog item; do not compose or publish a recipe.
