...
function liveOutcomeFixture(scenarioId, clientId) {
  ...
  const input = {
    ...
    client: {
      id: clientId,
      version: clientId === "github-copilot-cli" ? cli.selectedExactVersion : vscode.minimumSupportedVersion,
      binarySha256: clientId === "github-copilot-cli" ? hash("8") : hash("9"),
      ...(clientId === "github-copilot-vscode" ? { extensionVersion: vscode.historicalFixtureCopilotChatVersion } : {}),
      os: "linux",
      architecture: "x64",
    },
    execution: {
