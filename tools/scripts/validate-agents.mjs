...
const WORKFLOW_HANDOFF_RULES = [
  {
    ...
    appliesTo: "agent",
    sourceUrl:
      "https://github.com/jonathan-vella/apex-vnext/blob/main/.github/skills/workflow-engine/references/handoff-validation-rules.md#b1a",
  },
  {
    ...
    appliesTo: "agent",
    sourceUrl:
      "https://github.com/jonathan-vella/apex-vnext/blob/main/.github/skills/workflow-engine/references/handoff-validation-rules.md#b2",
  },
  {
    ...
    appliesTo: "agent",
    sourceUrl:
      "https://github.com/jonathan-vella/apex-vnext/blob/main/.github/skills/workflow-engine/references/handoff-validation-rules.md#b3",
  },
  {
    ...
    appliesTo: "agent",
    sourceUrl:
      "https://github.com/jonathan-vella/apex-vnext/blob/main/.github/skills/workflow-engine/references/handoff-validation-rules.md#b4",
  },
  {
    ...
    appliesTo: "agent",
    sourceUrl:
      "https://github.com/jonathan-vella/apex-vnext/blob/main/.github/skills/workflow-engine/references/handoff-validation-rules.md#b5",
  },
];
