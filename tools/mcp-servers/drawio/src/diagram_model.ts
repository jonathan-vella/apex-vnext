...
const WATERMARK_TEMPLATE =
  `<mxCell id="${WATERMARK_CELL_ID}" value="Generated by APEX - The Agentic Platform Engineering eXperience for Azure.&lt;br&gt;https://github.com/jonathan-vella/apex-vnext&lt;br&gt;Creation date: {{DATE}}" ` +
