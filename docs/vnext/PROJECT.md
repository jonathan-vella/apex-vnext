...
- **Working branch:** `main`; collection awaits operator-provided client access
...
1. Obtain explicit operator authorization and access for supported VS Code and Copilot CLI sampling under issue #126.
