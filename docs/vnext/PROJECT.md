...
- **Active issue:** [#105](https://github.com/jonathan-vella/apex-vnext/issues/105)
- **Working branch:** `refactor/105-validation-alias-delegation`
...
1. Complete issue #105's one-hop validation alias delegation without removing public commands.
...
3. Resume issue #105 from the `repository-validator-graph` ownership record; keep later implementation in independently
