...
export const contractMetadata: Readonly<Record<string, ContractMetadata>> = {
  ...
  "https://schemas.apexops.dev/client-outcome-v1.json": metadata(262_144, "confidential"),
  "https://schemas.apexops.dev/client-outcome-comparison-v1.json": metadata(65_536, "confidential"),
  "https://schemas.apexops.dev/client-outcome-qualification-v1.json": metadata(65_536, "confidential"),
