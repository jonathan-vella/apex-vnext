...
This directory contains all non-Bicep artifacts generated by the multi-step Agentic Workflow.
...
│   ├── 03-des-diagram.py            # Step 3: Design diagram source (Python)
│   ├── 03-des-diagram.png           # Step 3: Design diagram render (PNG)
│   ├── 03-des-diagram.svg           # Step 3: Design diagram render (SVG)
...
│   ├── 04-dependency-diagram.py      # Step 4: Dependency diagram source (Python)
│   ├── 04-runtime-diagram.py         # Step 4: Runtime diagram source (Python)
...
│   ├── 07-ab-diagram.py             # Step 7: As-built diagram source (Python)
