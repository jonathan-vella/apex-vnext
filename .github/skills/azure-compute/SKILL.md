---
name: azure-compute
description: '**ANALYSIS SKILL** — Recommend Azure VM sizes and VMSS for workload, performance, and budget. Uses public docs and direct ARM MCP retail pricing. WHEN: "recommend VM size", "choose Azure VM", "GPU VM", "compare VM sizes", "VMSS vs VM", "autoscale VMs". DO NOT USE FOR: provisioning VMs (azure-prepare), broad cost management (ARM MCP CostManagement tools).'
license: MIT
metadata:
  author: Microsoft
  version: "1.0.2"
