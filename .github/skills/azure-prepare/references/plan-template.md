...
- [ ] **⛔ For Azure Functions:** assess the trigger, identity, network, and observability requirements, then record unavailable materialization as a future backlog item
