...
_Generated with the [python-diagrams](../../.github/skills/python-diagrams/SKILL.md) skill_
...
| [03-des-diagram.py](./03-des-diagram.py)                         | Editable architecture source      | ![Done](https://img.shields.io/badge/-Done-success?style=flat-square) | {created-date} |
...
| [04-dependency-diagram.py](./04-dependency-diagram.py)             | Step 4 dependency source  | ![Done](https://img.shields.io/badge/-Done-success?style=flat-square) | {created-date} |
| [04-runtime-diagram.py](./04-runtime-diagram.py)                   | Step 4 runtime source     | ![Done](https://img.shields.io/badge/-Done-success?style=flat-square) | {created-date} |
...
**Generated by [APEX](../../README.md)** · [Report Issue](https://github.com/jonathan-vella/apex-vnext/issues/new)
