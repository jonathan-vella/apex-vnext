...
| `gpt-6`         | enforced      | Existing outcome-first rules retained by repository policy | `gpt-6-sol`, `gpt-6-luna` |
| `gpt-5.6`       | enforced      | GPT-5.5 rules apply (shared OpenAI cohort)           | `GPT-5.6 Terra`     |
