...
| [`release-candidate-qualification.yml`](release-candidate-qualification.yml) | Release-relevant PR/push + manual | Run exact-head deterministic, package, and scorecard qualification. | Uploads a compact evidence bundle; cannot deploy, merge, publish, tag, or authorize cutover. |
