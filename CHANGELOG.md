...
- Constrained Azure Pricing MCP to the supported Python MCP SDK v1 API family after the v2 stable release, preserving
  fresh-install CI compatibility and adding a dependency-contract regression.
