 ...
 * Markdown user guides. Currently checks:
 *   - `title:` is present
...
const DOCS_ROOT = path.join(REPO_ROOT, "docs", "guides");
...
async function main() {
  // Minimal package consumers may omit repository documentation.
  if (!existsSync(DOCS_ROOT)) {
    console.log(`✔ no user guides at ${path.relative(REPO_ROOT, DOCS_ROOT)} — frontmatter lint skipped.`);
    return;
  }
